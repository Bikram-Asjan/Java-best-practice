package com.tricky;
	...
	class SmallestSubStringWithDistinctCharacter
	{
	  ...
	  public static void main(String[] args) {
		  SmallestSubStringWithDistinctCharacter s = new SmallestSubStringWithDistinctCharacter();
		  String str = s.GetSubString("yyuiuiebfbhsddsssdfer", "hsddsssdfer");
